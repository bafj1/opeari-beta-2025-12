  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
      ...
      <Link
        ...
        className="bg-white border-2 border-border rounded-2xl p-4 flex gap-3 items-start hover:border-primary hover:-translate-y-0.5 hover:shadow-soft-lg transition-all"
      >
        ...
        <div className="flex-1">
          <h3 className="text-[15px] font-bold text-primary mb-0.5">Build Your Village</h3>
          <p className="text-[12px] text-text-secondary mb-2">Find nanny shares and care shares</p>
          <span className="inline-block px-2.5 py-1 bg-mint rounded-full text-[11px] font-semibold text-primary">
      ...
      >
        ...
        <div className="flex-1">
          ...
          <p className="text-[12px] text-text-secondary mb-2">Quick help from nearby parents</p>
