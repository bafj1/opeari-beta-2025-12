                        ...
                        <button
                            ...
                            className={`
                                ...
                                ${isSelected
                                    ...
                                    : 'bg-white border-[#8bd7c7]/30 hover:border-opeari-green/30 hover:shadow-sm'
                                }
                            `}
                        >
                            ...
                            <div className={`
                                ...
                                ${isSelected ? 'border-opeari-green bg-white' : 'border-[#8bd7c7]/30 group-hover:border-gray-400'}
                            `}>
