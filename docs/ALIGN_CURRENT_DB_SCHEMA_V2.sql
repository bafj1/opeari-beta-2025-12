-- SCHEMA ALIGNMENT V2: Fix Column Error
-- Run this in the Supabase SQL Editor for your CURRENT connected project.

-- 1. Create the 'waitlist' table (Safe if already exists)
...
-- 4. Data Migration (Fixed: Removed 'user_type' check)
DO $$
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'waitlist_entries') THEN
    ...
    SELECT 
      ...
      approved_at, invited_at, review_notes, created_at
